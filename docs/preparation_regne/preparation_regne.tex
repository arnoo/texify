...
\latin{Ave, Maria}, etc., en se prosternant devant elle, et lui demandant pour grâce de les honorer de quelques-uns de
...
annoncent ses miséricordes! Il n'y a pas un petit enfant qui, en bégayant l'\latin{Ave Maria}, ne la loue; il n'y a guère de
...
\versenb{41} Les figures et les paroles de l'Ancien et du Nouveau Testament le prouvent, les sentiments et les exemples
...
\subsubsection{Nous sommes à Jésus-Christ et à Marie en qualité d'esclaves.}
...
\subsubsection{Nous devons nous vider de ce qu'il y a de mauvais en nous.}
...
\subsubsection{Nous avons besoin d'un médiateur auprès du Médiateur même.}
...
\subsubsection{Il nous est très difficile de conserver les grâces et les trésors reçus de Dieu.}
...
avec attention, dévotion et modestie ou le saint rosaire composé de quinze dizaines d'\latin{Ave Maria} en l'honneur des
...
fois: \latin{Ave Maria, Virgo Fidelis}, pour obtenir de Dieu par elle la fidélité aux grâces de Dieu pendant la journée; et le
soir: \latin{Ave Maria, Mater misericordiae}, pour demander pardon à Dieu par elle des péchés qu'on a commis pendant
...
\paragraph{Cette dévotion nous livre entièrement au service de Dieu}
...
\paragraph{Cette dévotion nous fait imiter l'exemple donné par Jésus-Christ et par Dieu lui-même, et pratiquer l'humilité.}
...
\paragraph{Cette dévotion nous procure les bons offices de la Sainte Vierge.}
...
\paragraph{Cette dévotion est un chemin pour arriver à l'union avec Notre-Seigneur.}
...
\latin{Hierarchia Mariana}, dans lequel il traite, avec autant de piété que d'érudition, de l'antiquité, de l'excellence et de la
...
\versenb{163} On peut lire dans le livre de Mr Boudon les différents papes qui ont approuvé cette dévotion, les théologiens
...
\versenb{164} 2° Cette dévotion est un moyen assuré pour aller à Jésus-Christ, parce que le propre de la Sainte Vierge est
...
péché.
\versenb{167} Comme c'est Marie seule, dit l'Église et le Saint-Esprit qui la conduit, qui a seule fait périr toutes les hérésies:
...
\versenb{168} Quiconque donc, sans crainte d'illusion, qui est ordinaire aux personnes d'oraison, veut avancer dans la voie
...
\paragraph{Cette dévotion donne une grande liberté intérieure.}
...
pèchent: \latin{Virgo non solum in plenitudine sanctorum detinetur, sed etiam in plenitudine sanctos detinet, ne plenitudo
...
\subsubsection{3- Figure biblique de cette parfaite dévotion: Rébecca et Jacob}
...
mystères.
\subsubsection{4- Les effets merveilleux que cette dévotion produit}
...
\subsubsection{5- Pratiques particulières de cette dévotion}
...
\latin{Dignare me laudare te, Virgo sacrata; da mihi virtutem contra hostes tuos}; ensuite, on dira le \latin{Credo}, puis un \latin{Pater}, puis quatre \latin{Ave Maria} et un \latin{Gloria Patri}; encore un \latin{Pater}, quatre \latin{Ave}, un \latin{Gloria Patri}; ainsi du reste. A la fin, on dit: \latin{Sub tuum prœsidium.}
...
Grande dévotion à l'\latin{Ave Maria} et au chapelet.
\versenb{249} Cinquième pratique. Ils auront une grande dévotion à dire l'\latin{Ave Maria}, ou la Salutation angélique dont peu de
...
salut du monde ayant commencé par l'\latin{Ave Maria}, le salut de chacun en particulier était attaché à cette prière; que
...
qui doit faire germer dans nos âmes la parole de Dieu et porter le fruit de vie, Jésus-Christ; que l'\latin{Ave Maria} est une
...
haïssent ou méprisent l'\latin{Ave Maria} et le chapelet. Les hérétiques apprennent et récitent encore le Pater, mais non
pas l'\latin{Ave Maria}, ni le chapelet; c'est leur horreur: ils porteraient plutôt un serpent sur eux qu'un chapelet. Les
orgueilleux aussi, quoique catholiques, comme ayant les mêmes inclinations que leur père Lucifer, méprisent ou
n'ont que de l'indifférence pour l'\latin{Ave Maria}, et regardent le chapelet comme une dévotion de femmelette qui n'est
bonne que pour les ignorants et ceux qui ne savent point lire. Au contraire, on a vu, par expérience, que ceux et
celles qui ont d'ailleurs de grandes marques de prédestination aiment, goûtent et récitent avec plaisir l'\latin{Ave Maria};
...
connaître si une personne est de Dieu, que d'examiner si elle aime à dire l'\latin{Ave Maria} et le chapelet. Je dis: elle
...
\versenb{252} âMES PRÉDESTINÉES, ESCLAVES DE JÉSUS EN MARIE, apprenez que l'\latin{Ave Maria} est la plus belle de
...
dites comme il faut.
\versenb{253} L'\latin{Ave Maria} bien dit, c'est-à-dire avec attention, dévotion et modestie, est, selon les saints, l'ennemi du
diable, qui le met en fuite, et le marteau qui l'écrase, la sanctification de l'âme, la joie des anges, la mélodie des
prédestinés, le cantique du Nouveau Testament, le plaisir de Marie et la gloire de la Très Sainte Trinité. L'\latin{Ave Maria} est une rosée céleste qui rend l'âme féconde; c'est un baiser chaste et amoureux qu'on donne à Marie, c'est
...
par ces tendres paroles: \latin{Accipio te in mea omnia. Praebe mihi cor tuum, o Maria!}

\subsection{DANS LA COMMUNION}
\versenb{267} 2° Prêt de recevoir Jésus-Christ, après le Pater, vous lui direz trois fois: \latin{Domine, non sum dignus}, etc.,
...
\versenb{268} Vous direz au Fils: \latin{Domine, non sum dignus}, etc., que vous n'êtes pas digne de le recevoir à cause de vos
...
point aller qu'il ne soit venu loger chez elle: \latin{Tenui eum, nec dimittam, donec introducam illum in domum matris
meae, et in cubiculum genitricis meae} (Cant., 3. 4). Vous le prierez de se lever et de venir dans le lieu de son
repos et dans l'arche de sa sanctification: \latin{Surge, Domine, in requiem tuam, tu et arca sanctificationis tuae}. [Vous
...
\versenb{269} Vous direz au Saint-Esprit: \latin{Domine, non sum dignus}, que vous n'êtes pas digne de recevoir le chef-d'oeuvre
